...
class DunBradstreet:
    ...
    def extract(self):
        extract_company = list(
            pd.read_excel(
                r"C://Users//Sangamithra//Desktop//twitter//Domain_needed_Company.xlsx"
            )["company"]
        )
        ...
        df.to_csv(
            os.path.join(
                r"C://Users//Sangamithra//Desktop//twitter", "Domains_needed.csv"
            )
        )
    ...
    def selection(self):
        ...
        data_df.to_csv(r"C://Users//Sangamithra//Desktop//twitter//Domain2.csv")
    ...
    def parse(self, comp_url):
        ...
        dict["url"] = response.xpath(
            '//span[@name="company_website"]/span/a/@href'
        ).get()
